...
public class TimeAnalyseTest {
    ...
    public void test(){
        ...
        //String classPath = path.substring(0, path.indexOf("/time/"));
        ...
        normalizer.parse("今天和15号的天气怎么样");// 抽取时间
        TimeUnit[] unit = normalizer.getTimeUnit();
        System.out.println("今天到后天的天气怎么样");
        for(int i = 0; i < unit.length; i++){
      	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
      }
        
//        normalizer.parse("本周一");// 抽取时间
//        unit = normalizer.getTimeUnit();
//        System.out.println("十月一号五号天气");
//        for(int i = 0; i < unit.length; i++){
//      	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//      }
//
//      normalizer.parse("十月一号，二号　五号开会");// 多时间识别，
//      unit = normalizer.getTimeUnit();
//      System.out.println("十月一号，二号　五号开会");
//      for(int i = 0; i < unit.length; i++){
//      	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//      }
////      for(int i = 0; i < unit.length; i++){
...
////      }
//      
//      normalizer.parse("一号，二号　五号开会");// 多时间识别，
//      unit = normalizer.getTimeUnit();
//      System.out.println("一号，二号　五号开会");
//      for(int i = 0; i < unit.length; i++){
//      	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//      }
//      
//      normalizer.parse("周四下午开会");// 多时间识别，
//      unit = normalizer.getTimeUnit();
//      System.out.println("周二三开会");
//      for(int i = 0; i < unit.length; i++){
//      	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//      }
//
//        normalizer.parse("早上六点15分二十起床");// 注意此处识别到6天在今天已经过去，自动识别为明早六点（未来倾向，可通过开关关闭：new TimeNormalizer(classPath+"/TimeExp.m", false)）
//        unit = normalizer.getTimeUnit();
...
//
//        normalizer.parse("十月十日春游");// 残缺时间的识别 （打字输入时可便捷用户）
//        unit = normalizer.getTimeUnit();
//        System.out.println("十月十日春游");
//        System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
//        
//        normalizer.parse("十月十日到十二日春游");// 残缺时间的识别 （打字输入时可便捷用户）
//        unit = normalizer.getTimeUnit();
//        System.out.println("十月十日到十二日春游");
//        System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
//        System.out.println(DateUtil.formatDateDefault(unit[1].getTime()) + "-" + unit[1].getIsAllDayTime());
//        
//        normalizer.parse("十月十日和十二日春游");// 残缺时间的识别 （打字输入时可便捷用户）
//        unit = normalizer.getTimeUnit();
//        System.out.println("十月十日和十二日春游");
//        System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
//        System.out.println(DateUtil.formatDateDefault(unit[1].getTime()) + "-" + unit[1].getIsAllDayTime());
//        
//        normalizer.parse("下周日出差");// 多时间识别
//        unit = normalizer.getTimeUnit();
//        System.out.println("下周日出差");
//        System.out.println("unit.length: "+unit.length);
//        System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
//       // System.out.println(DateUtil.formatDateDefault(unit[1].getTime()) + "-" + unit[1].getIsAllDayTime());
//        
//        normalizer.parse("本周日下周日出差");// 多时间识别
//        unit = normalizer.getTimeUnit();
//        System.out.println("本周日下周日出差");
//        System.out.println("unit.length: "+unit.length);
//        System.out.println(DateUtil.formatDateDefault(unit[0].getTime()) + "-" + unit[0].getIsAllDayTime());
//        //System.out.println(DateUtil.formatDateDefault(unit[1].getTime()) + "-" + unit[1].getIsAllDayTime());
//
...
//        System.out.println(DateUtil.formatDateDefault(unit[1].getTime()) + "-" + unit[1].getIsAllDayTime());
//        
//        normalizer.parse("下午三点和周日五点开会");// 多时间识别，
//        unit = normalizer.getTimeUnit();
//        System.out.println("下午三点和周日五点开会");
//        for(int i = 0; i < unit.length; i++){
//        	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//        }
//        for(int i = 0; i < unit.length; i++){
//            System.out.println("时间文本:"+unit[i].Time_Expression +",对应时间:"+ DateUtil.formatDateDefault(unit[i].getTime()));
//        }
//        normalizer.parse("周一和周三，周四，周五开会");// 多时间识别，
//        unit = normalizer.getTimeUnit();
//        System.out.println("周一和周三，周四，周五开会");
//        for(int i = 0; i < unit.length; i++){
//        	System.out.println(DateUtil.formatDateDefault(unit[i].getTime()) + "-" + unit[i].getIsAllDayTime());
//        }
//        for(int i = 0; i < unit.length; i++){
